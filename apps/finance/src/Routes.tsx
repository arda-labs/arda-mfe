...
const LedgerPage = lazyWithPreload(() =>
  import("@/features/finance/ledger/page").then((m) => ({
    default: m.LedgerPage,
  }))
)
const CounterpartiesPage = lazyWithPreload(() =>
  import("@/features/finance/counterparties/page").then((m) => ({
...
const FundsPage = lazyWithPreload(() =>
  import("@/features/finance/funds/page").then((m) => ({
    default: m.FundsPage,
  }))
)
...
async function preload(pathname = "") {
  ...
  if (pathname.startsWith("/finance/funds")) page = FundsPage
