...
const SpecificProvisionPage = lazyWithPreload(() =>
  import("@/features/specific-provision/page").then((m) => ({
    default: m.SpecificProvisionPage,
  }))
)
...
async function preload(pathname: string) {
  ...
  else if (pathname.startsWith("/loans/specific-provision")) await SpecificProvisionPage.preload()
...
function RemoteRoutes() {
  ...
  else if (pathname.startsWith("/loans/specific-provision")) page = <SpecificProvisionPage />
