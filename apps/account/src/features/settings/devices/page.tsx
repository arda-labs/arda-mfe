    ...
    <div className="max-w-4xl space-y-6">
      <div className="border-b border-muted/50 pb-5">
        ...
        <p className="text-sm text-muted-foreground">
          Browsers and devices recognized from your recent sign-ins. Trusted
          devices skip MFA verification.
        </p>
      </div>
      ...
      <div className="grid gap-4">
        ...
        {devices.map((device) => (
          <Card
            key={device.id}
            className="group border-muted/40 bg-card/50 transition-all duration-300 hover:border-muted-foreground/10 hover:shadow-md"
          >
            <CardContent className="flex flex-col justify-between gap-4 p-5 md:flex-row md:items-center md:p-6">
              <div className="flex items-start gap-4">
                <div className="shrink-0 rounded-2xl bg-muted/50 p-3">
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="flex flex-wrap items-center gap-x-4 gap-y-1 text-xs text-muted-foreground/80">
                    <span className="flex items-center gap-1.5">
                      ...
                      First seen:{" "}
                      {new Date(device.firstSeenAt).toLocaleDateString()}
                    </span>
                    <span className="flex items-center gap-1.5">
        ...
        <AlertDialogContent className="rounded-2xl">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              {deleteTarget ? formatDeviceName(deleteTarget) : "this device"}
              &apos;? This will immediately revoke any active login sessions
              tied to this device.
            </AlertDialogDescription>
          </AlertDialogHeader>
