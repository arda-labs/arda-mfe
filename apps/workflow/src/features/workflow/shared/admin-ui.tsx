...
export function SlaTable({ items, onEdit }: { items: SlaPolicy[]; onEdit: (item: SlaPolicy) => void }) {
...
export function ProcessRoleTable({ items, onEdit }: { items: ProcessRole[]; onEdit: (item: ProcessRole) => void }) {
...
export function RoleCatalogTable({ items, onEdit }: { items: WorkflowRoleCatalog[]; onEdit: (item: WorkflowRoleCatalog) => void }) {
...
export function RoleMembershipTable({ items, onEdit }: { items: WorkflowRoleMembership[]; onEdit: (item: WorkflowRoleMembership) => void }) {
...
export function AssignmentRuleTable({ items, onEdit }: { items: WorkflowAssignmentRule[]; onEdit: (item: WorkflowAssignmentRule) => void }) {
...
export function DelegationTable({ items, onEdit }: { items: WorkflowDelegation[]; onEdit: (item: WorkflowDelegation) => void }) {
...
export function caseTypeOptionsFromCaseTypes(items: WorkflowCaseType[]): SelectOption[] {
...
export function roleOptionsFromCaseTypes(items: WorkflowCaseType[]): SelectOption[] {
